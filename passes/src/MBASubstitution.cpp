...
static constexpr std::array<SubFn, 5> AddSubs = {addVar0, addVar1, addVar2, addVar3, addVar4};
static constexpr std::array<SubFn, 5> SubSubs = {subVar0, subVar1, subVar2, subVar3, subVar4};
static constexpr std::array<SubFn, 5> XorSubs = {xorVar0, xorVar1, xorVar2, xorVar3, xorVar4};
static constexpr std::array<SubFn, 5> AndSubs = {andVar0, andVar1, andVar2, andVar3, andVar4};
static constexpr std::array<SubFn, 5> OrSubs = {orVar0, orVar1, orVar2, orVar3, orVar4};

static Value *pickAndApply(ArrayRef<SubFn> Variants, BinaryOperator *BO, IRBuilder<> &Builder,
                           std::mt19937 &RNG) {
...
PreservedAnalyses MBASubstitution::run(Function &F, FunctionAnalysisManager &AM) {
